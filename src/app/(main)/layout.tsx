...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (item: NavItem) => {
    if (item.href === "/dashboard" && pathname === "/") return true; // Treat root of (main) as dashboard
            ...
            <SidebarMenuItem>
                 <Link href="/" legacyBehavior passHref>
                    <SidebarMenuButton
                        ...
                        tooltip={{ children: "Logout", className: "bg-popover text-popover-foreground border"}}
                    >
